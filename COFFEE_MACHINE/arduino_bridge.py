...
BUTTON_CODE_MESSAGES = {
    ...
    "3": "[VISITOR PUSHED ESPRESSO MARTINI BUTTON]",
    "4": "[VISITOR PUSHED SUGAR BUTTON]",
    "5": "[VISITOR PUSHED START BUTTON, TELL THEM TO TAKE IT EASY]",
    "6": "[VISITOR PUSHED CAFE CREME BUTTON]",
    "7": "[VISITOR PUSHED ESPRESSO BUTTON]",
    "8": "[VISITOR PUSHED CAPPUCHINO BUTTON]",
    "9": "[VISITOR PUSHED CACAO BUTTON]",
    "a": "[VISITOR PUSHED ESPRESSCHOC BUTTON]",
    "b": "[VISITOR PUSHED SOUP BUTTON. You don't serve soup. Only coffee]",
