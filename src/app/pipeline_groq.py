# see also https://github.com/pipecat-ai/pipecat/blob/main/examples/foundational/14f-function-calling-groq.py
...
class VoicePipelineController:
    def __init__(
        ...
        *,
        ...
        self._llm_service: Optional[GroqLLMService] = None
    ...
    async def _switch_voice(self, persona: str):
        config = self._config_manager.config
        if persona == "persona1":
